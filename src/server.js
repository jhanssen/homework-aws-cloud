...
function makeDimmer(dev)
{
    var dimmer = {
        ...
        friendlyDescription: `${dev.name} dimmer connected by via Homework`,
...
function makeSwitch(dev)
{
    return {
        ...
        additionalApplianceDetails: {},
        applianceId: dev.uuid,
        friendlyDescription: `${dev.name} switch connected by via Homework`,
        friendlyName: makeName(dev),
        isReachable: true,
        manufacturerName: "Homework",
...
function makeThermostat(dev)
{
    var thermostat = {
        ...
        additionalApplianceDetails: {},
        applianceId: dev.uuid,
        friendlyDescription: `${dev.name} thermostat connected by via Homework`,
        friendlyName: makeName(dev),
        isReachable: true,
        manufacturerName: "Homework",
